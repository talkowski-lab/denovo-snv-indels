...
workflow filterUltraRareParentsVariantsHail {
    ...
    output {
        ...
        File downsampled_ultra_rare_parents_SNV = select_first([downsampleVariantsfromTSVRemoveRegions.downsampled_tsv_SNV, downsampleVariantsfromTSV.downsampled_tsv_SNV, prioritizeCSQ.vcf_metrics_tsv_prior_csq])
        File downsampled_ultra_rare_parents_Indel = select_first([downsampleVariantsfromTSVRemoveRegions.downsampled_tsv_Indel, downsampleVariantsfromTSV.downsampled_tsv_Indel, prioritizeCSQ.vcf_metrics_tsv_prior_csq])
    }
}
